 ...
 * В корневой директории проекта создать файл `.env`, который должен содержать следующие переменные:

    VITE_API_URL = 'https://test.prostoemenu.ru/api/v1'
    VITE_IMAGE_URL = 'https://test.prostoemenu.ru'
