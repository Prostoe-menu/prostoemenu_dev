...
from .serializers import RecipeDisplaySerializer, RecipeCreateSerializer, IngredientSerializer, \
    ParticipantCreateSerializer, TaskSerializer, ParticipantSerializer
...
class RecipeList(APIView):
    def get(self, request, format=None):
        recipes = Recipe.objects.all()#.prefetch_related(Prefetch('step', queryset=Step.objects.select_related()))
