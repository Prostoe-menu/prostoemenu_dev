    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('ingredient_alternative_volume', models.IntegerField(blank=True, verbose_name='Количество')),
                ('ingredient_alternative_measure', models.CharField(blank=True, max_length=20, verbose_name='Единица измерения')),
                ...
                ('ingredient_alternative', models.ForeignKey(blank=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='ingredient_alternative', to='recipe.ingredient', verbose_name='Номер альтернативы')),
                ('recipe', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='recipe.recipe', verbose_name='Номер рецепта')),
            ],
            options={
        ...
        migrations.AddField(
            model_name='recipe',
            name='category',
            field=models.ManyToManyField(blank=True, related_name='categories', through='recipe.RecipeCategories', to='recipe.category'),
        ),
        migrations.AddField(
            model_name='recipe',
            name='ingredient',
            field=models.ManyToManyField(blank=True, related_name='ingredients', through='recipe.RecipeIngredients', to='recipe.ingredient'),
        ),
        migrations.AddField(
            model_name='recipe',
            name='photo',
            field=models.ManyToManyField(blank=True, related_name='photos', through='recipe.RecipePhotos', to='recipe.photo'),
        ),
        migrations.AddField(
            model_name='recipe',
            name='step',
            field=models.ManyToManyField(blank=True, related_name='steps', through='recipe.RecipeSteps', to='recipe.step'),
        ),
        migrations.AddField(
            model_name='recipe',
            name='tag',
            field=models.ManyToManyField(blank=True, related_name='tags', through='recipe.RecipeTags', to='recipe.tag'),
        ),
        migrations.AddField(
            model_name='comment',
            name='recipe',
