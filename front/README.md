...
5. В описании PR участник ссылается на Issue, над которым работал, описыват результат и возможные проблемы/сложности
6. Если при создании PR образовался конфликт, его необходимо сразу разрешить
7. После получения двух аппрувов, лид делает squash коммитов и мерджит во frontend-ветку. Без согласования с лидом самостоятельно PR во frontend не мерджится

Пример наименования ветки: `development-1-cooking-steps`
